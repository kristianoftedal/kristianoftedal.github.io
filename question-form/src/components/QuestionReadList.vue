    ...
    <div class="twelve columns">
      ...
      <div v-bind:key="question['.key']" v-for="question in filteredQuestions">
        <div class="row">
          ...
          <div class="one columns">
            ...
            <button
              class="button-primary"
              v-if="question.editable"
              v-on:click="updateQuestion(question)"
            >Lagre</button>
          </div>
        </div>
        <div class="row">
        ...
        <div class="row">
          ...
          <div class="ten columns">
            <span style="width: 335.429px" id="test" v-html="textParser(question.explanation)"></span>
            <textarea
              v-if="question.editable"
        ...
        <div class="row">
          ...
          <div class="ten columns">
            <span v-if="!isEdit.includes(question.id)">
              {{question.imageId ?
            ...
            <img
              ...
              class="questionImage"
              v-bind:src="getImageSrc(question.imageId)"
            >
          </div>
        </div>
        <div class="row">
