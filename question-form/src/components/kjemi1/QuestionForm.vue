...
const kjemi1QuestionsRef = db.ref('kjemi1Questions');

export default {
  name: 'QuestionForm',
  firebase: {
    questions: db.ref('kjemi1Questions'),
  },
  computed: {
    questionsList() {
  ...
  methods: {
    addQuestion() {
      kjemi1QuestionsRef.push(this.question);
    ...
    deleteQuestion(question) {
      kjemi1QuestionsRef.child(question['.key']).remove();
    },
    downloadFile() {
